...
let productList=[
	{ img: 'it1.gif', url: 'product_T0.html', title: 'LIN퓨어 슬림배기핏 팬츠', size: '[ FREE ]' , price: 49000, discount: 0.25},
	{ img: 'it2.gif', url: 'product_T1.html', title: '러브레스 블라우스', size: '[ FREE ]' , price: 40000, discount: 0.30},
	{ img: 'it3.gif', url: 'product_T2.html', title: '뉴케이블 꽃버튼 가디건', size: '[ S , M , L ]' , price: 60000, discount: 0.30},
	{ img: 'it4.gif', url: 'product_T3.html', title: '오브더베이 배색카라 맨투맨', size: '[ S , M , L ]' , price: 30000, discount: 0.25},
	{ img: 'it5.gif', url: 'product_T4.html', title: '밀키그린 배색카라 맨투맨', size: '[ S , M , L ]' , price: 30000, discount: 0.30},
	{ img: 'it6.gif', url: 'product_T5.html', title: '밀라노 골드버튼 클래식 자켓', size: '[ FREE ]' , price: 80000, discount: 0.25},
	{ img: 'it7.gif', url: 'product_T6.html', title: '마그레츠 슈포켓 자켓', size: '[ FREE ]' , price: 80000, discount: 0.25},
	{ img: 'it8.gif', url: 'product_T7.html', title: '로렌 로맨틱 스커트', size: '[ FREE ]' , price: 40000, discount: 0.25}
]
...
function productPrint(){
	...
	for(let i = 0; i < productList.length; i++){
		...
		html += `<div class="itemBox" onclick="clickImg(i)">
					<a href="html/${ productList[i].url}"><img src="img/${ productList[i].img}"></a>
				</div>`
	}
